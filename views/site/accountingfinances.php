<?php
    /*$this->registerJsFile(
        ...
        $first_bloc_key = array_search('accfin_first_bloc', array_column($content_index, 'type'));
        $title_service_key = array_search('accfin_title', array_column($content_index, 'type'));
      ...
      <section class="section-md bg-default">
       <div class="text-center">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="type" aria-describedby="emailHelp" placeholder="Название на русском" maxlength="250" value="accfin">
        </div>
