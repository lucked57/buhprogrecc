<?php
    /*$this->registerJsFile(
        ...
        $first_bloc_key = array_search('service_first_bloc', array_column($content_index, 'type'));
        $title_service_key = array_search('service_title', array_column($content_index, 'type'));
      ...
      <section class="section-md bg-default">
       <div class="text-center">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="type" aria-describedby="emailHelp" placeholder="Название на русском" maxlength="250" value="service">
        </div>
...
<!--
  ...
  #спаниель #русскийохотничийспаниель #кокер #кокерспаниель #хендлинг #английскийкокерспаниель #хендлер #рос #лучшийдругчеловека #сидеть #угс #послушнаясобака #воспитаниещенка #обучениесобак #служебныесобаки #кожаныйнос #дрессировкамосква #собакамосква #воспитаниесобак #дрессировкасобакмосква #дрессировкасобак #worlddogs #dogtrainers #trainingdogs #worlddogday #дрессировкасобаки #кинологмосква #дрессировкащенка #кинолог #кинологи
